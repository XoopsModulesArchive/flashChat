...
<body bgcolor="#FFFFCC" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" <?php if ($lin) { ?>onLoad="setFocus()" onUnload="doLogout()"<?php } ?>>
<table width="100%" height="100%" border="0" cellpadding="8" cellspacing="0">
    <tr>
        <td height="50" colspan="2"><p><span class="title">ACME Widgets</span><br>
                <span class="normal">Serving all your widget needs since 1995!</span></p></td>
    </tr>
    <tr>
        <td width="150" valign=top bgcolor="#FFFF99" nowrap>
        ...
        <td width="90%" valign=top bgcolor="#FFFFFF">
            <table width="100%" border="0" cellspacing="0" cellpadding="4">
                ...
                if ($lin) {
                    ...
                    echo 'Thanks for joining our chat! If you have any follow-up questions, please feel free to e-mail our <a href=mailto:support@acmewidgets.widget>support department</a> after the chat.</td></tr>';
                    ...
                    echo flashTag($id, 'preloader.swf', '600', '500', $params);

                    echo '</td></tr>';

                    echo '<tr><td class=normal>Legal notice: opinions expressed in this chat session are not necessarily officially endorsed by ACME Widgets.</td></tr>';
                } else {
                    ?>
                    ...
                    <tr>
                        <td class="normal">Welcome to our chat room. This system requires the
                            ...
                            need a password unless you are a chat moderator.
                        </td>
                    </tr>
                    <tr>
                        <td valign=top>
                            ...
                            <form method="post">
                                ...
                                <table width="100%" border="0" cellpadding="2" cellspacing="0" class="normal">
                                    <tr>
                                        ...
                                        <td width="84%"><input name="username" type="text" class="normal" size="20"></td>
                                    </tr>
                                    <tr>
                                        <td>
